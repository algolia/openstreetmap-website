 ...
 * -----------------
 *
 * Uses Algolia's JavaScript client to
 * suggest a list of 5 world cities.
 *
 * It also implements directional keys for
 * selecting values.
 *
 * The init() function takes the following
 * (mandatory) parameters: 
 *
 *   var citiesAc = new AlgoliaCityAutocomplete();
 *
 *   citiesAc.init({
 *     index: <algolia index used for search>,
 *     el: <input[type="text"] element id or class>,
 *     resultsClass: <string>
 *   }); 
 *
 * where *index* is the Algolia index object, 
 * el is the CSS selector for the text input 
 * and resultsClass is a specific class name
 * added to the results list (useful for styles).  
 * 
 */
